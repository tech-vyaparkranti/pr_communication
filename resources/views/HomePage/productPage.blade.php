                   ...
                   <div class="col-md-12 mb-4 offerings-container">
                    <div class="offerings-block">
                        <div class="offerings-content">
                            <div class="offerings-content-inner">
                                <h3>Basmati Rice</h3>
                                <p class="text-justify">Adiyogi Global offers premium Basmati Rice, known for its long grains, aromatic fragrance, and
                                    delicate texture. Sourced from the fertile plains of India, our Basmati Rice is perfect for gourmet
                                    dishes, providing unmatched flavor and quality. We ensure every batch is meticulously selected
                        ...
                        <div class="offerings-figure" data-aos="zoom-in-up">
                            <img src="./assets/img/Basmati rice.jpeg" class="img-fluid rounded" width="" height="" alt="Bikaner" >
                        </div>
                ...
                <div class="col-md-12 mb-4 offerings-container">
                        <div class="offerings-block">
                            <div class="offerings-content">
                                ...
                                <p class="text-justify">Our Non-Basmati Rice varieties cater to diverse culinary needs, offering robust taste and
versatility. Carefully sourced from India’s best paddy fields, these grains are ideal for a wide
range of dishes, from everyday meals to specialty cuisines. Adiyogi Global guarantees consistent
quality and exceptional value for global markets.
</p>
                            ...
                            <div class="offerings-figure" data-aos="zoom-in-down">
                                <img src="./assets/img/Non Basmati Rice 2.jpg" class="img-fluid rounded" width="" height="" alt="Bikaner"  />
                            </div>
                        </div>
                    </div>
                <div class="col-md-12 mb-4 offerings-container">
                    <div class="offerings-block">
                        <div class="offerings-content">
                            <div class="offerings-content-inner">
                            <h3>Ground Spices</h3>
                                    <p class="text-justify">Adiyogi Global’s ground spices are finely milled from the highest quality whole spices, ensuring
rich, authentic flavors. Perfect for seasoning and enhancing dishes, our ground spices deliver
potent taste and aroma. We uphold strict quality control to meet international standards, offering
importers a reliable source of premium spice blends</p>
                                <a href="javascript:void(0)" type="button" data-bs-toggle="modal"
                                data-bs-target="#enquery-pop"><i class="fa fa-link" aria-hidden="true"></i> Enquiry Now</a>
                            </div>
                        </div>
                            <div class="offerings-figure" data-aos="zoom-in-down">
                                <img src="./assets/img/Ground Spice -2.jpg" class="img-fluid rounded" width="" height="" alt="Bikaner" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4 offerings-container">
                        <div class="offerings-block">
                            <div class="offerings-content">
                                <div class="offerings-content-inner">
                                    <h3>Whole Spices</h3>
                                    <p class="text-justify">Our whole spices are sourced directly from India’s finest farms, retaining their natural oils and
robust flavors. Adiyogi Global provides a diverse selection, from cardamom to cumin, ensuring
freshness and potency. Ideal for importers seeking authentic spices, our products enhance global
cuisines with their rich, aromatic qualities.
</p>
                                    <a href="javascript:void(0)" type="button" data-bs-toggle="modal"
                                    data-bs-target="#enquery-pop"><i class="fa fa-link" aria-hidden="true"></i> Enquiry Now</a>
                                </div>
                            ...
                            <div class="offerings-figure" data-aos="zoom-in-down">
                                <img src="./assets/img/Whole Spices 2.jpg" class="img-fluid rounded" width="" height="" alt="Bikaner"  />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4 offerings-container">
                        <div class="offerings-block">
                            <div class="offerings-content">
                                <div class="offerings-content-inner">
                                    ...
                                    <p class="text-justify">Adiyogi Global supplies a wide range of fresh fruits and vegetables, harvested at peak ripeness to
ensure superior taste and nutrition. Our produce is carefully packed to maintain freshness during
international transit, meeting the highest standards. Importers can trust us for a consistent supply
of vibrant, high-quality produce.</p>
                                    <a href="javascript:void(0)" type="button" data-bs-toggle="modal"
                                    data-bs-target="#enquery-pop"><i class="fa fa-link" aria-hidden="true"></i> Enquiry Now</a>
                                </div>
                            </div>
                            <div class="offerings-figure" data-aos="zoom-in-down">
                                <img src="./assets/img/Fruit & Vegitables 2.jpg" class="img-fluid rounded" width="" height="" alt="Bikaner" />
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-md-12 mb-4 offerings-container">
